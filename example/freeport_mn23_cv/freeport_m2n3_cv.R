...
#todo:
#2,4,0.996,1.0000e-07,
#2,4,0.994,2.1544e-06,
#2,4,0.995,2.1544e-06,
#2,4,0.994,4.6416e-06,
#2,4,0.994,4.6416e-06,
#2,4,0.995,4.6416e-06,   (0.996  went OK)
#0.988 trough 0.996 using zeta= 2 e-5

#trial_zeta <- c(5.e-8,1.e-7,5.e-7,1.e-6,5.e-6,1e-5)
third = 1./3.
twothird = 2./3.
trial_zeta <- 10^(seq(-8.-third,-7-twothird,third))
trial_rho <- c(0.997)


#trial_zeta <- c(10^(-6+third))
#trial_rho <- c(0.0994)
