...
output.subtide_parm.plot(ax=ax0,label='SCHA(2,4) Mean Param',color='0.4',markersize=5,markevery=markerspace,style=['-^'])
...
output.D1_amp_parm.plot(ax=ax1,label='SCHA(2,4) Mean Param',color='0.4',markersize=5,markevery=markerspace,style=['-^'])
...
output.D2_amp_parm.plot(ax=ax2,label='SCHA(2,4) Mean Param',color='0.4',markersize=5,markevery=markerspace,style=['-^'])
...
output.D3_amp_parm.plot(ax=ax3,label='SCHA(2,4) Mean Param',color='0.4',markersize=5,markevery=markerspace,style=['-^'])
